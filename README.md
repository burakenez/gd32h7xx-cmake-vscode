[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32h7xx-cmake-vscode)](https://github.com/burakenez/gd32h7xx-cmake-vscode/tags/)

# GD32H7xx Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32H7xx Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32H7xx Demo Suites V2.1.0](https://www.gd32mcu.com/en/download)_** and **_[GD32H73x 75x Firmware Library V1.6.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32h7xx-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32H7xx**
- **Version:** `V1.6.0 (2026-03-24)`
- **Path:** `Drivers/CMSIS/GD/GD32H7xx`
- **Source:** `GD32H73x 75x Firmware Library V1.6.0`

### 3. **GD32H73x_75x_usbhs_library**
- **Version:** `V1.6.0 (2026-03-24)`
- **Path:** `Drivers/GD32H73x_75x_usbhs_library`
- **Source:** `GD32H73x 75x Firmware Library V1.6.0`

### 4. **GD32H73x_75x_standard_peripheral**
- **Version:** `V1.6.0 (2026-03-24)`
- **Path:** `Drivers/GD32H73x_75x_standard_peripheral`
- **Source:** `GD32H73x 75x Firmware Library V1.6.0`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32h7xx_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32h7xx_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32h7xx_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32h7xx.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32h7xx.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32H757J_START              # Board support package for GD32H757J_START
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32H7xx
│           │   └── GD32H7xx_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32h7xx_flash.ld  # Linker script (memory regions)
│           └── GD32H7xx.svd             # SVD file for peripheral register views
